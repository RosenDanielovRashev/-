...
class EnhancedPDF(FPDF):
    ...
    def add_formula_section(self, title, formulas, columns=2, col_width=95, img_width=85, row_gap=8):
        ...
        for row in rows:
            ...
            self.ln(max(18, int(max_row_height)) + )
...
def generate_pdf_report():
    ...
    pdf.add_formula_section("Основни формули за изчисление:", formulas_section2, columns=2, col_width=95, img_width=85, row_gap=1)
    ...
    pdf.add_formula_section("Изчислителни формули:", formulas_section3, columns=2, col_width=95, img_width=85, row_gap=1)
