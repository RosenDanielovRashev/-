...
if st.button("📄 Генерирай PDF отчет (с информация)", type="primary"):
    try:
        ...
        info_table.setStyle(TableStyle([
            ...
            ('FONTSIZE', (0, 0), (-1, 0), 9),
            ('ALIGN', (0, 0), (-1, 0), 'LEFT'),  # Ляво за целия header
            ...
            ('FONTSIZE', (0, 1), (-1, -1), 8),
            ('ALIGN', (0, 1), (-1, -1), 'LEFT'),  # Ляво за всички данни
        ...
        # Позициониране на цялата таблица в ляво
        story.append(Paragraph("", info_style))  # Празен параграф за ляво подравняване
