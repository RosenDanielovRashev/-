...
if st.button("📄 Генерирай PDF отчет (с информация)", type="primary"):
    try:
        ...
        # Създаваме контейнер таблица с 1 колона, за да позиционираме основната таблица в ляво
        container_table = Table([[info_table]], colWidths=[112*mm])  # 64+48=112mm
        container_table.setStyle(TableStyle([
            ('ALIGN', (0, 0), (-1, -1), 'LEFT'),  # Позициониране в ляво
        ...
        # Добавяме контейнер таблицата вместо директно info_table
