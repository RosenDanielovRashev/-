...
if st.button("📄 Генерирай PDF отчет (с информация)", type="primary"):
    try:
        ...
        # 20% по-малки ширини на колоните
        ...
        info_table.setStyle(TableStyle([
            ...
            ('FONTSIZE', (0, 0), (-1, 0), 9),
            ('ALIGN', (0, 0), (0, 0), 'LEFT'),  # Ляво подравняване за първа колона
            ('ALIGN', (1, 0), (1, 0), 'LEFT'),  # Ляво подравняване за втора колона
            ('BOTTOMPADDING', (0, 0), (-1, 0), 5),
            ('TOPPADDING', (0, 0), (-1, 0), 5),
            ('LEFTPADDING', (0, 0), (-1, 0), 5),  # Отстояние отляво
            ('RIGHTPADDING', (0, 0), (-1, 0), 5), # Отстояние отдясно
            ...
            ('FONTSIZE', (0, 1), (-1, -1), 8),
            ('ALIGN', (0, 1), (0, -1), 'LEFT'),  # Ляво подравняване за първа колона
            ('ALIGN', (1, 1), (1, -1), 'LEFT'),  # Ляво подравняване за втора колона
            ('BOTTOMPADDING', (0, 1), (-1, -1), 3),
            ('TOPPADDING', (0, 1), (-1, -1), 3),
            ('LEFTPADDING', (0, 1), (-1, -1), 5),  # Отстояние отляво
            ('RIGHTPADDING', (0, 1), (-1, -1), 5), # Отстояние отдясно
